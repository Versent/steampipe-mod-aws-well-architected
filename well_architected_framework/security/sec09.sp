...
benchmark "well_architected_framework_sec09_bp01" {
  ...
  children = [
    control.csv_well_architected_framework_sec09_bp01,
...
benchmark "well_architected_framework_sec09_bp02" {
  ...
  children = [
    control.csv_well_architected_framework_sec09_bp02,
...
benchmark "well_architected_framework_sec09_bp03" {
  ...
  children = [
    control.csv_well_architected_framework_sec09_bp03,
...
control "csv_well_architected_framework_sec09_bp01" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC09-BP01'
    EOT
}
...
control "csv_well_architected_framework_sec09_bp02" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC09-BP02'
    EOT
}
...
control "csv_well_architected_framework_sec09_bp03" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC09-BP03'
    EOT
}
