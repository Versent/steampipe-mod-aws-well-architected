...
benchmark "well_architected_framework_sec03" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp01,
...
benchmark "well_architected_framework_sec03_bp01" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp02,
...
benchmark "well_architected_framework_sec03_bp02" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp03,
...
benchmark "well_architected_framework_sec03_bp04" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp04,
...
benchmark "well_architected_framework_sec03_bp05" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp05,
...
benchmark "well_architected_framework_sec03_bp06" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp06,
    aws_compliance.control.iam_user_unused_credentials_90,
...
benchmark "well_architected_framework_sec03_bp07" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp07,
    aws_compliance.control.dms_replication_instance_not_publicly_accessible,
...
benchmark "well_architected_framework_sec03_bp08" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp08,
    aws_compliance.control.dms_replication_instance_not_publicly_accessible,
    aws_compliance.control.es_domain_in_vpc,
    aws_compliance.control.opensearch_domain_in_vpc,
    aws_compliance.control.ec2_instance_in_vpc,
...
benchmark "well_architected_framework_sec03_bp09" {
  ...
  children = [
    control.csv_well_architected_framework_sec03_bp09,
    aws_compliance.control.dms_replication_instance_not_publicly_accessible,
  ]
...
control "csv_well_architected_framework_sec03_bp01" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP01'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp02" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP02'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp03" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP03'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp04" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP04'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp05" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP05'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp06" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP06'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp07" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP07'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp08" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP08'
    EOT
}
...
control "csv_well_architected_framework_sec03_bp09" {
  ...
  sql = <<EOT
    ...
    from
      war
    where
      pillar = 'security' AND best_practise = 'SEC03-BP09'
    EOT
}